...
export function createApp(): Application {
  ...
  // No static /uploads mount here: user-uploaded images now live on
  // Cloudinary (see services/imageStorage.ts) and are served directly from
  // there, not proxied through this server.
